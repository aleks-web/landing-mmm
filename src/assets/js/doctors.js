...
export const doctors = [
    {
        ...
        modal: {
            ...
            stage: '5 лет',
            rating: '5.0',
            info: 'Иванов Павел Вячеславович, Тюмень: стоматолог-ортопед, 22 отзыва пациентов, места работы, стаж 5 лет',
...

    {
        ...
        modal: {
            ...
            stage: '35 лет',
            rating: '4.4',
            info: 'Быржыбаев Джылдызбек Исаевич, Тюмень: стоматолог-ортопед, 7 отзывов пациентов, места работы, стаж 35 лет',
            content: 'Специализируется на сложных клинических случаях и полной реабилитации зубного ряда. Подбирает решения, сочетая проверенные методики и современные технологии, чтобы добиться надежного и эстетичного результата.',
            updated: '21.11.2025',
...

    {
        ...
        modal: {
            ...
            stage: '14 лет',
            rating: '5.0',
            info: 'Каримов Хетаг Маратович, Тюмень: стоматолог-ортопед, стоматолог, 26 отзывов пациентов, места работы, высшая категория, стаж 14 лет',
            content: 'Специализируется на эстетическом и функциональном восстановлении зубов, в том числе с помощью виниров и сложных ортопедических конструкций. Помогает вернуть не только красивую улыбку, но и полноценное жевание.',
            updated: '15.03.2026',
...

    {
        ...
        modal: {
            ...
            stage: '12 лет',
            rating: '5.0',
            info: 'Бондаренко Михаил Романович, Тюмень: стоматолог-имплантолог, стоматолог-хирург, 84 отзыва пациентов, места работы, стаж 12 лет',
            content: 'Специализируется на хирургических вмешательствах и имплантации зубов, в том числе в сложных случаях при дефиците костной ткани. Работает точно, аккуратно и с максимальным комфортом для пациента.',
            updated: '21.03.2026',
...

    {
        ...
        modal: {
            ...
            stage: '15 лет',
            rating: '5.0',
            info: 'Аббасов Низами Вагиф оглы, Тюмень: стоматолог-имплантолог, стоматолог-хирург, 49 отзывов пациентов, места работы, стаж 15 лет',
            content: 'Специализируется на атравматичной хирургии и современной имплантации. Помогает восстановить зубы быстро, безопасно и с предсказуемым результатом даже в сложных клинических случаях.',
            updated: '13.01.2026',
...

    {
        ...
        modal: {
            ...
            stage: '8 лет',
            rating: '4.7',
            info: 'Акрамов Улугбек Ахмадович, Тюмень: стоматолог-хирург, 14 отзывов пациентов, места работы, стаж 8 лет',
            content: 'Специализируется на аккуратном и атравматичном удалении зубов, помогает быстро снять боль и устранить воспаление. Обеспечивает комфортное лечение и грамотную подготовку.',
            updated: '26.02.2025',
...

    {
        ...
        modal: {
            ...
            stage: '5 лет',
            rating: '5.0',
            info: 'Бебик Анна Игоревна, Тюмень: стоматолог-гигиенист, 21 отзыв пациентов, места работы, стаж 5 лет',
            content: 'Помогает сохранить здоровье зубов и дёсен, делая процедуры максимально комфортными. Подбирает индивидуальный уход и объясняет, как избежать кариеса и пульпита.',
            updated: '10.12.2025',
...

    {
        ...
        modal: {
            ...
            stage: '6 лет',
            rating: '5.0',
            info: 'Макарова Алла Александровна, Тюмень: стоматолог-гигиенист, 6 отзывов пациентов, места работы, стаж 6 лет',
            content: 'Специализируется на деликатной и эффективной профессиональной гигиене. Помогает не только очистить зубы и осветлить эмаль, но и предотвратить развитие кариеса и заболеваний дёсен.',
            updated: '13.11.2025',
...

    {
        ...
        modal: {
            ...
            stage: '2 года',
            rating: '4.9',
            info: 'Гофман Мария Владимировна, Тюмень: стоматолог-гигиенист, 13 отзывов пациентов, места работы, стаж 2 года',
            content: 'Внимательный специалист, проводит процедуры максимально бережно.',
            updated: '22.02.2026',
...

    {
        ...
        modal: {
            ...
            stage: '8 лет',
            rating: '4.9',
            info: 'Стоян Татьяна Юрьевна, Тюмень: стоматолог, 19 отзывов пациентов, места работы, стаж 8 лет',
            content: 'Специализируется на качественном и бережном лечении зубов, помогает сохранить зубы даже в сложных случаях. Восстанавливает эстетику и функциональность зубов, чтобы улыбка выглядела естественно и красиво.',
            updated: '12.11.2025',
...

    {
        ...
        modal: {
            ...
            stage: '2 года',
            rating: '4.9',
            info: 'Лымар Максим Григорьевич, Тюмень: стоматолог-эндодонтист, 24 отзыва пациентов, места работы, стаж 2 года',
            content: 'Проводит лечение зубов с упором на сохранение тканей и долгосрочный результат.',
            updated: '04.12.2025',
...

    {
        ...
        modal: {
            ...
            stage: '16 лет',
            rating: '4.3',
            info: 'Хусаинов Азамат Минизакиевич, Тюмень: стоматолог, 12 отзывов пациентов, места работы, стаж 16 лет',
            content: 'Опытный специалист, который помогает сохранить зубы даже в сложных случаях. Точно подбирает тактику лечения, обеспечивая долгосрочный результат и комфорт для пациента.',
            updated: '04.03.2026',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function replaceDataInModal(doctor, modal) {
        ...
        info.innerText = doctor.modal.info;
